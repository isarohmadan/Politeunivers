...
if ( ! class_exists( 'WP_Bootstrap_Navwalker' ) ) {
	...
	class WP_Bootstrap_Navwalker extends Walker_Nav_Menu {
		...
		public function start_lvl( &$output, $depth = 0, $args = array() ) {
			...
			$output .= "\n$indent<ul role=\"menu\" class=\" dropdown-menu absolute left-0 bg-black p-5\" >\n";
		}
		...
		public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if ( 0 === strcasecmp( $item->attr_title, 'divider' ) && 1 === $depth ) {
				...
				$class_names = $class_names ? ' class="' . esc_attr( $class_names ) .' my-5"' : '';
				...
				if ( isset( $args->has_children ) && $args->has_children && 0 === $depth ) {
					...
					$atts['class']         = 'dropdown-toggle relative';
